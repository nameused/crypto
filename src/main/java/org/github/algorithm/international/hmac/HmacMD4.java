 ...
 * @Company Dingxuan
 */
public class HmacMD4 implements IHmac {
    private static CryptoLog log = CryptoLogFactory.getLog(HmacMD4.class);
    private static final String ALGORITHM_NAME = "HmacMD4";
