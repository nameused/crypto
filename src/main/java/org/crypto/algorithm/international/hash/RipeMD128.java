 ...
 * @Company Dingxuan
 */
public class RipeMD128 implements IHash {
    private static CryptoLog log = CryptoLogFactory.getLog(RipeMD128.class);
    private static final String ALGORITHM_NAME = "RipeMD128";
    @Override
