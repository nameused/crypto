...
public class CertUtil {
     ...
     * @throws Exception
     */
    public static X509Certificate genGmCertHelper(boolean isCA, PublicKey pubKey, PrivateKey privKey, String dn, int validData, String dnsName, String rfc822Name) throws Exception{
