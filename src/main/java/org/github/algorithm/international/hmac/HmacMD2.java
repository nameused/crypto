 ...
 * @Company Dingxuan
 */
public class HmacMD2 implements IHmac {
    private static CryptoLog log = CryptoLogFactory.getLog(HmacMD2.class);
    private static final String ALGORITHM_NAME = "HmacMD2";
